    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserShopLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserShopLists_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserShopLists_ShopLists_ShopListId",
                        column: x => x.ShopListId,
                        principalTable: "ShopLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopListDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopListDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShopListDetails_ShopLists_ShopListId",
                        column: x => x.ShopListId,
                        principalTable: "ShopLists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShopListDetails_ProductId",
                table: "ShopListDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopListDetails_ShopListId",
                table: "ShopListDetails",
                column: "ShopListId");

            migrationBuilder.CreateIndex(
                name: "IX_UserShopLists_AppUserId",
                table: "UserShopLists",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserShopLists_ShopListId",
                table: "UserShopLists",
                column: "ShopListId");
        }
